<template>
	<view>
		<!-- 标签 -->
		<!-- :scroll-left='activeIndex*80'设置横向跟着移动 -->
		<scroll-view class="tab" scroll-x="true">
			<view class="tab-box">
				<view class="tab-box-item" v-for="(item,index) in list" :key="index" @click="navClickFn(index)"
...
<script>
	export default {
		data() {
			return {
				list: ['前端开发01', '前端开发02', '前端开发03', '前端开发04', '前端开发05', '前端开发06'],
				activeIndex: 0,
			}
		},
		methods: {
