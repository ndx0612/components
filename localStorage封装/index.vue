<template>
  <div>
    <el-button @click="aa">存储</el-button>
    <el-button @click="bb">获取</el-button>
  </div>
</template>
...
const config = {
  type: "localStorage", // 本地存储类型 可选：sessionStorage,localStorage
  prefix: "SDF_0.0.1", // 名称前缀 建议：项目名 + 项目版本
  expire: 60 * 60 * 24 * 7, //过期时间 单位：秒
...
// 根据索引获取key
const getStorageForIndex = (index) => {
